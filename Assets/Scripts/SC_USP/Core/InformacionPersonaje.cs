...
namespace USP.Core
{
    ...
    /// </summary>
    public class InformacionPersonaje : MonoBehaviour, IHealth
{
    ...
    public bool IsDead => vidaActual <= 0f;
    public void TakeDamage(float amount, GameObject attacker) => RecibirDanio(amount);
}
}
