...
namespace USP.Weapons
{
    ...
    public class Proyectil : MonoBehaviour
    {
        ...
        void OnCollisionEnter2D(Collision2D collision)
        {
            ...
            /*
                UnassignedReferenceException: The variable owner of Proyectil has not been assigned.
                You probably need to assign the owner variable of the Proyectil script in the inspector.
                UnityEngine.Object.get_name()(at < 56073df97ede4f769c2cc45d546d986d >:0)
                USP.Weapons.Proyectil.OnCollisionEnter2D(UnityEngine.Collision2D collision)(at Assets / Scripts / SC_USP / Weapons / Proyectil.cs:41)
            */
