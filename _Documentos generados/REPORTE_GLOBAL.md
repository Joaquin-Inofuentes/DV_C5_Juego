# 📘 Reporte global — DV_C5_Juego

_Generado: 2026-06-11 21:15:41_
...
- Propiedades: 241
- Campos: 1261
- Líneas totales: 43728 (código 32702, comentarios 2979, blancos 8047)
...
- Archivo: `IA_P2_AgentIA.cs` (236 líneas)
- Hereda de: `MonoBehaviour`
...
- Archivo: `SquadEventBus.cs` (25 líneas)
- Usa: `UnitController`
...
- Archivo: `UnitModel.cs` (43 líneas)
- Hereda de: `MonoBehaviour`
- Implementa: `IHealth`
- Usa: `UnitTeam`
...
- Archivo: `Rigidbody2DMovementHandler.cs` (66 líneas)
- Hereda de: `MonoBehaviour`
...
- Archivo: `IDetectable.cs` (7 líneas)
...
Generado: 2026-06-11 21:15:41

Tipos: 430 · Métodos: 1565 · Propiedades: 241 · Campos: 1261 · Eventos: 19
...
- Accesibilidad: `public`
- Modificadores: `public`
- Archivo: `IA_P2_AgentIA.cs` · líneas 7-242 (236)
- Hereda de: `MonoBehaviour` (profundidad 0)
- Usa: `IA_P2_PathfindingModel`, `IA_P2_PathfindingManager`, `IA_F_PathFinding_Theta`
...
| private void Update() | 12 | 29 | 49 | Atan2, Euler, Slerp, GetComponent, MovePosition, Max, DrawLine |
| public void StopAgent() | 1 | 3 | 7 |  |
| public bool IsMoving() | 1 | 1 | 4 |  |
| public bool IsOnFinalPathSegment() | 4 | 5 | 11 |  |
| public void LookAtTarget(Vector3 targetPosition) | 3 | 7 | 14 | Atan2, Euler, Slerp |
...
- Accesibilidad: `public`
- Modificadores: `public`, `static`
- Archivo: `SquadEventBus.cs` · líneas 5-29 (25)
- Usa: `UnitController`
...
- `TriggerHelpRequested`: Emite un pedido de ayuda al escuadrón. priority 1 = líder atacado (urgente), priority 2 = aliado atacado.
...
- Accesibilidad: `public`
- Modificadores: `public`
- Archivo: `UnitModel.cs` · líneas 5-47 (43)
- Hereda de: `MonoBehaviour` (profundidad 0)
- Implementa: `IHealth`
- Usa: `UnitTeam`
...
- Accesibilidad: `public`
- Modificadores: `public`
- Archivo: `Rigidbody2DMovementHandler.cs` · líneas 5-70 (66)
- Hereda de: `MonoBehaviour` (profundidad 0)
- Implementa: `IMovementHandler`
- Usa: `BD_Audios`
...
| public void RotateTowards(Transform targetTransform, Vector3 targetPosition) | 2 | 4 | 8 |  |
...
- Accesibilidad: `public`
- Archivo: `IDetectable.cs` · líneas 3-9 (7)
...
- Accesibilidad: `public`
- Modificadores: `public`
- Archivo: `IDetectable.cs` · líneas 11-16 (6)
- Usa: `DetectableType`
...
| Rigidbody2DMovementHandler | Game.MVC | class | Rigidbody2DMovementHandler.cs | 66 | 4 | 0 | 0 | MonoBehaviour | IMovementHandler | BD_Audios |
...
| SquadEventBus |  | static class | SquadEventBus.cs | 25 | 4 | 0 | 0 |  |  | UnitController |
| DetectableEntity | Game.Sensors | class | DetectableEntity.cs | 15 | 4 | 2 | 0 | MonoBehaviour | IDetectable | DetectableType |
| DetectableType | Game.Sensors | enum | IDetectable.cs | 7 | 0 | 4 | 0 |  |  |  |
...
| IA_P2_AgentIA |  | class | IA_P2_AgentIA.cs | 236 | 11 | 12 | 0 | MonoBehaviour |  | IA_P2_PathfindingModel; IA_P2_PathfindingManager; IA_F_PathFinding_Theta |
...
| UnitModel |  | class | UnitModel.cs | 43 | 5 | 13 | 4 | MonoBehaviour | IHealth | UnitTeam |
